...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <form id="nbform" class="form-horizontal form-label-left" action="modifyAppInfo" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" id="softwareSize" min="1" name="softwareSize" value="${appInfo.softwareSize}" required="required"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" id="downloads" min="10" name="downloads" value="${appInfo.downloads}" required="required"
