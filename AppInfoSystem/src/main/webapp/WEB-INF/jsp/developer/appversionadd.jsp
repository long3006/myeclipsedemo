    ...
    <div class="x_panel">
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
        ...
        <div class="x_content" style="display: block;">
         <br>
        <form class="form-horizontal form-label-left" action="addappversion.html" method="post" enctype="multipart/form-data">
           <input type="hidden" name="appId" name="appId" value="${appversionId}">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              data-validate-minmax="10,500" min="1" placeholder="请输入版本大小，单位为Mb" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
